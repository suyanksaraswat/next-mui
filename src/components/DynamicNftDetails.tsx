...
interface DynamicNftDetailsI {
  nftId: string;
}

export default function DynamicNftDetails({ nftId }: DynamicNftDetailsI) {
                    ...
                    <Typography variant="body2">
                      <div
                        dangerouslySetInnerHTML={{
                          __html: nftDetails?.collection_id?.perks_description,
                        }}
                      />
                    </Typography>
                  </Box>
                </Box>
                {nftDetails?.isDisplayed &&
                  (address ? (
                    <Box
                      p={2}
                      sx={{
                    ...
                    >
                      ...
                      >
                        <Button
                          ...
                          variant="contained"
                          onClick={() => {
                            router.push(`/nft-details/${nftId}/checkout`);
                          }}
                        >
                          Buy
                        </Button>
                    ...
                    >
                      ...
                      <Box
                        ...
                        sx={{
                          div: { width: "100%" },
                          button: { width: "100%", textAlign: "center !important" },
                        }}
                      >
