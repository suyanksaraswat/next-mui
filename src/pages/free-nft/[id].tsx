        ...
        >
          {!success ? (
            <Box margin="auto" maxWidth={500} width="100%">
              <Box mb={2}>
                <Typography variant="h2" sx={{ fontFamily: "Syne" }} textAlign="center">
                  Enter details
                </Typography>
              </Box>
              <Box mb={6}>
                <Typography
                  ...
                  sx={{
                    color: "grey",
                    span: {
                      background: "linear-gradient(#FD8900, #FFBA56)",
                      WebkitBackgroundClip: "text",
                      WebkitTextFillColor: "transparent",
                    },
                  }}
                >
                  Enter your details to receive the <span>FREE</span> NFT
                </Typography>
              </Box>
              <Box mb={2}>
                <TextField
            ...
            <>
              ...
              >
                ...
                >
                  Congratulations! You have just claimed a NFT which will be
              ...
              >
                ...
                >
                  Follow the Gajendra Verma discord for more information
                </Typography>
                <Box mt={2}>
                  <Button
                    fullWidth
                    variant="contained"
                    onClick={() => window.open("https://discord.gg/bxMJJj6nnn")}
                  >
                    <Image
